...
import static javaposse.jobdsl.plugin.ConfigFileProviderHelper.*;

/**
 * Manages Jenkins jobs, providing facilities to retrieve and create / update.
 */
public class JenkinsJobManagementCustom extends AbstractJobManagement {
    ...
    public JenkinsJobManagementCustom(PrintStream outputLogger, Map<String, String> envVars, File workspace) {
        super(outputLogger);
